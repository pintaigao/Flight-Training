  ...
  return (
    <div className="page">
      ...
      <div className="grid-4">
        ...
        <div className="card stat">
          ...
          <div className="stat-value">
            {last30Hours} <span className="stat-unit">hrs</span>
          </div>
        </div>
        <div className="card stat">
          <div className="muted">Landings</div>
          <div className="stat-value">{flights.length * 2}</div>
        </div>
        <div className="card stat">
          <div className="muted">Night Flights</div>
          <div className="stat-value">{Math.min(5, flights.length)}</div>
        </div>
      </div>
      ...
      <div className="grid-2">
        ...
        <div className="card">
          <div className="card-title">Continue Writing Your Last Flight</div>
          {selected ? (
            <>
              <div className="muted">
              ...
              <div style={{ height: 8 }} />
              <Link className="btn-primary" to={`/flights/${selected.id}`}>
                Resume Entry
              </Link>
              <div style={{ height: 12 }} />
              {/* prettier-ignore */}
