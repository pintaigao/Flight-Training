...
import { readForeFlightKmlTimeRange } from '@/lib/geo/foreflightKmlTimeRange'
  ...
  return (
    <div className="page">
      ...
      <div className="cards">
        ...
        {flights.length === 0 && <div className="muted">No flights yet. Import a ForeFlight KML to create or attach a track.</div>}
      </div>
