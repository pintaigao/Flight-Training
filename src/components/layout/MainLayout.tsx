...
export default function MainLayout() {
  ...
  const sidebarWidth = '108px';
  
  const gridTemplateColumns = sidebarCollapsed && isMapPage ? '0px 1fr' : `${sidebarWidth} 1fr`;
  ...
  return (
    <div
      ...
      <main className={['private-main min-w-0', isWorkspacePage ? 'relative h-[100svh] overflow-hidden p-0' : 'p-4 sm:p-6 lg:p-8'].join(' ')}>
        {isMapPage && (
          <button
